...
//    {
//        cal_derivative(&(this->particle_list[p]), step); // calculate first time step derivatives from first time step particle list
//    }
//
//    //////////////// FIRST HALF STEP
//    for (int p = 0; p < this->particle_list.size(); p++) // for all particles in the domain
...
//            for (int i = 0; i < 2; i++) // updates position and velocity parameters (in x and y directions) for a single particle, using derivatives computed previously
//            {
//                // QUESTION: SHOULD WE ENSURE PARTICLES STAY WITHIN BOUNDARIES HERE? IF SO, UNCOMMENT THIS
//
...
//    for (int p = 0; p < this->particle_list.size(); p++) // for all particles in the domain
//    {
//        cal_derivative(&(this->particle_list[p]), step); // recalculate particle derivatives using half step particle properties
//    }
//
//    //////////////// SECOND HALF STEP
//    for (int p = 0; p < this->particle_list.size(); p++) // for all particles in the domain
...
//    }
//
//    update_min_time_step(step);
//
//    //if (this->max_dt >= 0.0013)
//    //cout << this->max_dt << endl;
//
